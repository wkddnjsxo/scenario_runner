...
class ProtoBuilder:
    def build(self, proto_path, output_path):
        ...
        for subdir in subdirs:
            ...
            self._build_core(current_path, real_proto_path, output_path)
...
if __name__ == '__main__':
    proto_path = os.path.normpath(os.path.join(current_path, 'morai'))
    protoc_path = os.path.normpath(os.path.join(current_path, 'output_py'))
